...
This repository is a practical Data Warehouse implementation and learning project focused on demonstrating the design and implementation of an analytical data platform using SQL Server and T-SQL.

The project documentation, ETL logic, warehouse structures and metadata should evolve together to maintain consistency between the implementation and its documented business and technical rules.
